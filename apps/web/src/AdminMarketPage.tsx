...
export const AdminMarketPage = () => {
  ...
  const save = async (event: React.FormEvent) => {
    ...
    if (response.ok) {
      ...
      setMessage("Market configuration updated and recorded.");
